...
export function RegisterRoutes(app: Router) {
  ...
  app.post(
    ...
    async function UserController_signin(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUserController_signin,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function BookController_list(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function BookController_getById(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsBookController_getById,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function BookController_create(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsBookController_create,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function BookController_delete(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsBookController_delete,
          request,
          response,
        });
